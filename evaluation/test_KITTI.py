...
if __name__ == '__main__':
    ...
    parser.add_argument('--chosen_snapshot', default='PGNet_KITTI_yw1', type=str, help='snapshot dir')
    ...
    for i in range(50, 101):
        miss = model.load_state_dict(torch.load(f'/media/lixiaohan/下载/huohu/PointDSC-master/snapshot/{args.chosen_snapshot}/models/model_{i}.pkl'), strict=False)
        print(miss)
        model.eval()
