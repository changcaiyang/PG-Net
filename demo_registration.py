...
if __name__ == '__main__':
    ...
    parser.add_argument('--chosen_snapshot', default='PGNet_3DMatch_yw', type=str, help='snapshot dir')
    ...
    config_path = f'/media/lixiaohan/下载/huohu/PGNet-master/snapshot/{args.chosen_snapshot}/config.json'
    ...
    miss = model.load_state_dict(
        torch.load(f'/media/lixiaohan/下载/huohu/PGNet-master/snapshot/{args.chosen_snapshot}/models/model_best.pkl', map_location=device), strict=False)
    print(miss)
    model.eval()
